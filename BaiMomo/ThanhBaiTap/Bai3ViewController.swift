...
class Bai3ViewController: UIViewController {
    ...
    //anh fb
        ...
        //pass
        passField.topAnchor.constraint(equalTo: userField.bottomAnchor, constant: 0).isActive = true
        ...
        //return
        returnButton.topAnchor.constraint(equalTo: forgotButton.bottomAnchor, constant: 20).isActive = true
